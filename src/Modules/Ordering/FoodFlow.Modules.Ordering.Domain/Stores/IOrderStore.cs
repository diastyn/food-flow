...
public interface IOrderStore
{
    ...
    public Task<IReadOnlyList<OrderModel>> GetManyAsync(CancellationToken cancellationToken);

    public Task<OrderId> AddAsync(Order order, CancellationToken cancellationToken);
}
